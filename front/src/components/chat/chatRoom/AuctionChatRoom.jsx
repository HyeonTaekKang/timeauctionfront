...
const AuctionChatRoom = ({room}) => {

    const thumbnailImageUrl = `https://dsi4a4vms3mme.cloudfront.net/` + `${room.auctionThumbnailUrl.replace('origin/', 'thumbnail/')}`;
            ...
            <div className="room-detail-block">
                ...
                <div className="room-detail">
                    <div className="room-title-room-latestMessageCreatedAt">
                        <span className="room-title" dangerouslySetInnerHTML={{__html: room.auctionTitle}}/>
...
export default AuctionChatRoom;